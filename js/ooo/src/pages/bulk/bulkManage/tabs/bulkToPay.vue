  ...
  <section v-loading.body="fullScreenLoading">
    <div class="search-content">
      <el-row :gutter="10">
        ...
        <el-col :span="4">
          <el-select v-model="reqParams.customerPayStatuses" class="width251" @change="getData">
    ...
    <div class="el-bulkTable-content">
      <el-table :data="tableData" :height="tableHeight" border>
        ...
        <el-table-column label="支付时间" prop="payTime" width="160" align="left" :formatter="formatTime"></el-table-column>
        ...
        <el-table-column label="支付状态" width="120">
          <template slot-scope="scope">
            <span class="forgive-color" v-if="scope.row.customerPayStatus == 0">未支付</span>
            <span class="forgive-color" v-if="scope.row.customerPayStatus == 1">已支付</span>
            <span v-if="scope.row.customerPayStatus == 2" class="red-color">白条申请失败</span>
          </template>
        </el-table-column>
