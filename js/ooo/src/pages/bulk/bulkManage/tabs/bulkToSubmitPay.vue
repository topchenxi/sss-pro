  ...
  <section v-loading.body="fullScreenLoading">
    ...
    <div class="el-bulkTable-content">
      <el-table :data="tableData" :height="tableHeight" border>
        ...
        <el-table-column label="当前状态" prop="" width="120" align="left">
          <template slot-scope="scope">
            <span class="forgive-color">{{scope.row.statusDesc}}</span>
          </template>
        </el-table-column>
        <el-table-column label="是否验货" prop="" width="100">
          <template slot-scope="scope">
            <span v-if="scope.row.checkCloth == 1">验货</span>
            <span v-if="scope.row.checkCloth == 0">不验货</span>
          </template>
        </el-table-column>
        <el-table-column label="配送方式" prop="" width="120">
          <template slot-scope="scope">
        ...
        <el-table-column label="订单发布时间" align="left" prop="createTime" width="160" :formatter="formatTime"></el-table-column>        
        <el-table-column label="订单总金额" align="right" prop="saleMoney" width="120" :formatter="formatNumber"></el-table-column>        
        <el-table-column label="提货方式" min-width="120px">
          <template slot-scope="scope">
