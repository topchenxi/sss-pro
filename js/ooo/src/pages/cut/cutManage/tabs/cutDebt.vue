    ...
    <div class="el-cutTable-content">
      <el-table :data="tableData" :height="tableHeight" border>
        ...
        <el-table-column label="订单状态" prop="" width="140" align="left">
          <template slot-scope="scope">
            <span v-if="scope.row.reconciliationStatus == 0" class="forgive-color">欠款-未结清</span>
            <span v-if="scope.row.reconciliationStatus == 1" class="forgive-color">欠款-已结清</span>
          </template>
        </el-table-column>
