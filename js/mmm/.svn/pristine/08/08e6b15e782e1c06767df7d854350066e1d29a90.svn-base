 ...
 * 2016-09-08 此文件已经被更改得面目全非 不能直接替换 替换要找永黄
 * 2016-09-08 此文件已经被更改得面目全非 不能直接替换 替换要找永黄
 * 2016-09-08 此文件已经被更改得面目全非 不能直接替换 替换要找永黄
 * 2016-09-08 此文件已经被更改得面目全非 不能直接替换 替换要找永黄
 * 2016-09-08 此文件已经被更改得面目全非 不能直接替换 替换要找永黄
...
+ function($) {
    ...
    var defaults = {}
    var currentProvince, raw, provinces, currentCity, currentDistrict
    const init = function(params) {
        /*
            增加 cityData 参数 
         */
        raw = params.cityData || $.smConfig.rawCitiesData;
        console.log(params)
