  ...
  <div>
    ...
    <div class="oms-content">
      ...
      <div class="main-wrap">
        <div class="main-content picker-content" :style="{ height : windowHeight - 330 + 'px' }">
          <div class="item" v-for="(item,index) in list" :key="index">
            <div class="title">
              ...
              <ul class="pick-count">
                <li>待发货（<i>{{item.orderList.length}}</i>）</li>
              </ul>
            </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(orderItem,orderIndex) in item.orderList" :key="orderIndex" :class="{'checked' : orderItem.checked}">
                    ...
                    <!-- 订单状态 -->
                    <td>
                      <span v-if="orderItem.status == '2'" class="green">待发货</span>
                    </td>
                    <!-- 销售备注 -->
                    ...
                    <!-- 操作 -->
                    <td>
                      <el-button class="table-btn" @click.native="send(orderItem)">确认发货</el-button>
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <div class="page-wrap">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="params.pageNumber" :page-sizes="[10, 30, 50, 100]" :page-size="params.pageSize" layout="total, sizes, prev, pager, next" :total="total">
          </el-pagination>
        </div>
      </div>
