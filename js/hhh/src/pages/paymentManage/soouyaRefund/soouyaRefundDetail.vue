  ...
  <section min-width="1300">
    ...
    <div class="form-box">
      <el-form label-position="right" label-width="120px">
        ...
        <el-form-item label="原销售货款值">
          <span>{{obj.soouyaPayToBuyer | formatMoney}}元</span>
        </el-form-item>
        <template v-if="obj.type == 1 || obj.type == 3">
        ...
        <template v-if="obj.type == 4 && obj.purchaserRemark != ''">
          <!-- <el-form-item label="现采购数">
                          <span>{{obj.needBuyQuantity | formatMoney}}{{obj.needBuyQuantityUnit}}</span>
                        </el-form-item> -->
          <!--换货码单  -->
        ...
        <template v-if="obj.type == 3 && obj.purchaserRemark != ''">
          <el-form-item label="买货员退货备注">
            <span>{{obj.purchaserRemark }}</span>
          </el-form-item>
        </template>
        <template v-if="obj.type == 3 && obj.followerRemark != ''">
          <el-form-item label="跟单员退货备注">
            <span>{{obj.followerRemark}}</span>
          </el-form-item>
        </template>
        <template v-if="obj.type == 4 && obj.followRemark != ''">
