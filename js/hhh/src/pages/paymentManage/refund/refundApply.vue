  ...
  <section style="min-width:1300">
    ...
    <div class="table-box">
      <el-table :data="tableData" border>
        ...
        <el-table-column align="left" label="订单总金额">
        ...
        <el-table-column label="供应商退款" align="right">
          <template scope="scope">
            <span>￥{{scope.row.sellerRefundForFollower | formatMoney}}</span>
          </template>
        </el-table-column>
        <!-- <el-table-column :show-overflow-tooltip="true" prop="purcahserExceptReson" label="异常原因" align="left"></el-table-column> -->
        <el-table-column label="操作" align="left" min-width="150px;">
          <template scope="scope">
            <template v-if="scope.row.hasException == 1">
              <!--按钮事件  -->
              <!-- <el-button size="mini" type="primary" @click.native="showCancelApplyDialog(scope.row)">取消申请</el-button> -->
    ...
    <!--取消申请退款dialog  -->
    <!-- <el-dialog title="取消申请" v-model="cancelApplyDialogVisible">
              <el-form label-width="80" label-position="right" style="margin-left:35%;">
                ...
                <el-form-item>
                  增加点击事件
                  <el-button type="primary" size="small">确定取消</el-button>
