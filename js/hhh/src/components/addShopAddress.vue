    ...
    <el-form label-width="100px" ref="addressForm" :model="formData">
      ...
      <el-form-item label="电话类型">
        <div style="text-align:left">
          <el-radio-group v-model="formData.telType">
            <el-radio-button label="手机" @click.native="formData.tel = ['']"></el-radio-button>
            <el-radio-button label="固话" @click.native="formData.tel = ['','']"></el-radio-button>
          </el-radio-group>
        </div>
      </el-form-item>
