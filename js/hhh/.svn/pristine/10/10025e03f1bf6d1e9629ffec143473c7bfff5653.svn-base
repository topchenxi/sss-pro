<template>
  <section class="detail">
    ...
    <div class="detail-group">
      <div class="detail-item order-quote">
        <h6>报价信息</h6>
        <div class="quote-list p14">
          <div class="price-show-image">
            <router-link :to="{name: 'guiderSalesTable', query: {orderNumber: obj.order.orderNumber, status: 2}}" target="_blank">
          ...
          <div class="price-show-image">
            <el-col class="card" :href="item" :key="item" v-lightbox="madanImgUrls" v-for="(item, index) in madanImgUrls" v-show="index == 0">
              <el-card :body-style="{ padding: '5px' }">
                <img :src="item" class="image">
                <div style="padding: 0;">
                  <p>原供应商码单
                    <span>({{madanImgUrls.length}}张)</span>
                  </p>
                </div>
              </el-card>
            </el-col>
          </div>
          <router-link :to="{name: 'guiderQuoteTable', query: {orderNumber: obj.order.orderNumber}}" target="_blank">
            <div class="price-show-image">
              <el-col class="card" :key="item" v-for="(item, index) in ['http://www.soouya.com/upload/redwood/madan/61d98194-4960-4a48-a72a-90e89017fb33.jpg']" v-show="index == 0">
                <el-card :body-style="{ padding: '5px' }">
                  <img :src="item" class="image">
      ...
      <div class="orderMsg">
        <el-form label-width="120px" label-position="right">
          <el-form-item label="原供应商">
            ...
            <p style="height:20px;">{{obj.product.shopProvince}} {{obj.product.shopCity}} {{obj.product.shopArea}} {{obj.product.shopAddr}}</p>
          </el-form-item>
    ...
    <!-- <div>
      <span style="font-weight:700">报价信息</span>
    </div>
    <div class="orderMsg">
      <el-form label-width="120px" label-position="right">
        <el-form-item>
          ...
          <div class="price-show-image">
            <el-col style="margin-right: 10px;" class="card" :href="item" :key="item" v-lightbox="madanImgUrls" v-for="(item, index) in madanImgUrls" v-show="index == 0">
              <el-card :body-style="{ padding: '5px' }">
                <img :src="item" class="image">
                <div style="padding: 0;">
                  <p>原供应商码单
    ...
    getData() {
      ...
      newRequest({
        ...
        if (res.success) {
          ...
          // this.obj = config.editOrder.obj
          this.sendCertificateList = this.formateImgList(this.obj.price.sendCertificateList)
          this.soouyaCertificateList = this.formateImgList(this.obj.price.soouyaCertificateList)
          this.buyerCertificateList = this.formateImgList(this.obj.price.buyerCertificateList)
          this.madanImgUrls = this.formateImgList(this.obj.price.madanImgUrls)
          ...
          this.saleMadanImgUrls = this.formateImgList(this.obj.price.saleMadanImgUrls)
...
.orderMsg {
  ...
  margin-top: 7.5px;
  padding-left: 10px;
  padding-right: 10px; // border: 0.5px solid #ccc;
  .el-form {
    // margin: 0px;
    .el-form-item {
      padding: 0px;
