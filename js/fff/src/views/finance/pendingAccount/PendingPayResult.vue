    ...
    <div class="box">
      ...
      <div class="content">
        ...
        <el-table :data="payResult.payTransactionList" border>
          ...
          <el-table-column property="createTime" label="受理时间"  width="160" :formatter="formatTime"></el-table-column>
          ...
          <el-table-column property="accountBranch" label="收款方开户支行" width="150"></el-table-column>
          <el-table-column property="accountBankId" label="联行号" width="150"></el-table-column>
          ...
          <el-table-column property="accountNumber" label="收款方银行账号" width="150"></el-table-column>
          ...
          <el-table-column property="userNumber" label="供应商ID" width="150"></el-table-column>
          <el-table-column property="userName" label="供应商名称" width="150"></el-table-column>
          ...
          <el-table-column property="yfbTransactionNo" label="易付宝交易号" width="150"></el-table-column>
          <el-table-column property="payStatus" label="受理状态" width="150" :formatter="getPayStatus"></el-table-column>
        </el-table>
        <el-row>
