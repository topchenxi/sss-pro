...
<div class="pending-account" v-loading.fullscreen="fullscreenLoading">
  ...
  <div v-loading='loading'>
    ...
    :height="height" @selection-change="handleMultipleSelectionChange">
      ...
      <el-table-column  property="confirmPayTime" label="退款时间" width="150" :formatter="formatTime" ></el-table-column>
      <el-table-column property="serviceNumber" label="订单号" width="170"  ></el-table-column>
      ...
      <el-table-column property="transactionNo" label="支付流水号/出金" width="170"  > </el-table-column>
      <el-table-column property="yfbTransactionNo" label="易付宝交易号" width="150"  >
      </el-table-column>
      <el-table-column property="buyerCompany" label="采购商"  ></el-table-column>
      <el-table-column property="sellerCompany" label="供应商" width="150"  > </el-table-column>
      <el-table-column property="refundMoney" label="搜芽退款金额/元" width="150"  ></el-table-column>
      <el-table-column inline-template label="退换类型" width="100"  >
         <div>
