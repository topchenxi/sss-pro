<template lang="html">
  <div class="content" v-loading.fullscreen="fullscreenLoading">
    <!-- <h1 style="font-size: 25px; padding: 15px">付款列表</h1> -->
    <div class="box">
      <p> 账户余额: <a href="http://pay.suning.com" target="_blank">查询</a> </p>
      <el-row>
        <el-col :span="12" :offset="7"> 申请支付笔数：{{dispatch.applyCount}}笔 </el-col>
        <el-col :span="12" :offset="7"> 申请支付金额：{{dispatch.applyMoney}}元 </el-col>
      </el-row>
      <el-col :span="12" :offset="3">
        <el-form :model="payForm" label-width="150px">
          <!-- <el-form-item label="短信验证码" prop="accountName">
            <el-col :span="11">
              <el-input v-model="payForm.smsCode" auto-complete="off"></el-input>
            </el-col>
          ...
          <el-form-item label="请输入支付密码">
            <el-input type="password" name="pwd" style="display:none"></el-input>            
            <el-input v-model="payForm.payPassword" name="pwd" type="password" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      newRequest({
        url: AccountApi.PayTransaction.comfirmPay,
        method: 'post',
        ...
        if (data.success === '1') { // 业务正常，但包含付款失败
          ...
          this.$router.push('/finance/pendingAccount/payResult');
        } else { // 支付密码错误
          this.$message({
            type: 'error',
            showClose: true,
